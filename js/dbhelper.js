...
const favouritePromise = idb.open('favourite_IDB' , 1  , function(upgradeDb) {
    upgradeDb.createObjectStore('favourite', {keyPath: 'id'})});
    ...
    class DBHelper {
        ...
        //     //restaurantPromise = DBHelper.openIDB();
        //     return restaurantPromise.then(function (db) {
        //         // check if db exists
        //         if (!db) return;
                                ...
                                .then(async reviews => {
                                    ...
                                    fetch(`${DBHelper.DATABASE_URL}/restaurants/${id}`)
                                        ...
                                        .then(fetchedRestaurant => {
                                            ...
                                            cachedRestaurantStore.put(cachedRestaurants);
